...
def migrate_data():
    ...
    try:
        ...
        # 清空所有表中的数据
        print("清空现有数据...")
        tables = ['attachments', 'replies', 'topics', 'forums', 'users']
        for table in tables:
